...
Training and workshop templates for Cloud Scale Analytics presentations and documentation.
...
**Training presentations** are designed for:
...
[Provide Feedback](https://github.com/fgarofalo56/csa-inabox-docs/issues/new?title=[Feedback]+Training-Templates)
