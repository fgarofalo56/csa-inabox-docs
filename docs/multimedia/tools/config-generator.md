...
```text
✅ Validating: multimedia-config.yaml
...
⚠️  Performance: max_concurrent=8 may cause resource issues (recommended: 4)
✅ Output paths: Valid and writable
❌ azure.storage.account: Environment variable AZURE_STORAGE_ACCOUNT not set
...
```text
🎬 CSA Multimedia Configuration Wizard
...
✅ Configuration generated: multimedia-config.yaml
