...
Comprehensive documentation for Stream Analytics.
...
This section provides comprehensive documentation for stream analytics.
...
To get started with stream analytics:
