...
Comprehensive documentation for Data Lake Analytics.
...
This section provides comprehensive documentation for data lake analytics.
...
To get started with data lake analytics:
