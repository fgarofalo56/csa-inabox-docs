...
Comprehensive documentation for Stream Analytics Synapse.
...
This section provides comprehensive documentation for stream analytics synapse.
...
To get started with stream analytics synapse:
