# Stream Analytics Cosmos

Comprehensive documentation for Stream Analytics Cosmos.
...
This section provides comprehensive documentation for stream analytics cosmos.
...
To get started with stream analytics cosmos:
